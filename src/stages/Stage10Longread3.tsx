...
export const Stage10Longread3 = () => {
  ...
  return (
    <div className="screen">
      ...
      {/* old waiting mindset */}
      <Reveal delay={0.12}>
        <div className="panel" style={{ marginBottom: 12, borderColor: 'rgba(212,59,54,0.25)' }}>
      ...
      {/* the turn */}
      <Reveal delay={0.28}>
        <div className="panel" style={{ marginBottom: 14, borderColor: 'rgba(51,214,230,0.45)', background: 'rgba(51,214,230,0.05)', boxShadow: 'var(--glow-cyan)' }}>
